...
namespace SpawnLocator
{
    ...
    // One "I stood here and the relic made sound X" observation.
    //
    // MinDist/MaxDist are resolved from the relic's band table at entry time and stored
    // absolutely, so swapping relics mid-hunt never retroactively changes what an old
    ...
    class Reading
    {
        ...
        // The relic reports a rounded distance, not the raw continuous value, so a true
